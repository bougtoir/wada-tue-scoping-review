#!/usr/bin/env python3
"""Create STROBE/RECORD checklist for Lancet Regional Health – Western Pacific submission.

Combines STROBE (observational) + RECORD extension (routinely-collected data).
"""
...
run2 = subtitle.add_run(
    ...
    '47 Prefectures: an ecological study'
)
...
items = [
    ...
    ('Title and abstract', '1', 'STROBE 1(b): Provide an informative and balanced summary of what was done and found', 'Structured abstract (Background, Methods, Findings, Interpretation, Funding)', 'Abstract'),
    ...
    ('Results', '17', 'STROBE 17: Report other analyses done', 'Per-capita rates, drug class sub-analyses, acute\u2013chronic correlation', 'Results'),
    ('Discussion', '18', 'STROBE 18: Summarise key results with reference to study objectives', 'Three principal findings summarised', 'Discussion, first paragraph'),
    ('Discussion', '19', 'STROBE 19: Discuss limitations, potential biases, and ecological fallacy', 'Ecological fallacy, no diagnosis codes, unmeasured confounders, no SCR', 'Discussion: Strengths and limitations'),
    ('Discussion', '20', 'STROBE 20: Give a cautious overall interpretation of results', 'Challenges monolithic stereotype; individualised assessment recommended', 'Discussion: Conclusion'),
    ('Discussion', '21', 'STROBE 21: Discuss the generalisability of the study results', 'Western Pacific and multicultural settings; framework replicable', 'Discussion'),
    ('Other', '22', 'STROBE 22: Give the source of funding and role of funders', 'No funding; funder role statement in Methods', 'Methods, Contributors'),
    ('Other', '', 'RECORD 22.1: Data governance and ethics', 'Public aggregate data; no ethical approval required', 'Methods: Study design'),
    ('Other', '', 'Data accessibility', 'NDB URL provided; analysis code on GitHub', 'Data sharing'),
]
...
outpath = os.path.join(LRH_DIR, 'LRH_STROBE_RECORD_checklist.docx')
doc.save(outpath)
