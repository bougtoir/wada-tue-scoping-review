...
p.alignment = WD_ALIGN_PARAGRAPH.CENTER
run = p.add_run(
    "SCJ-D-26-00070: Mind the Gap: A Scoping Review of Discrepancies Between WADA Therapeutic Use Exemptions and Current Clinical Practice Guidelines"
)
run.font.size = Pt(21)
run.italic = True
...
comments_r1 = [
    ...
    (
        ...
        "The Asthma section now explicitly states WADA's rationale: systemic beta-2 agonists can increase lean body mass and reduce fat mass, and permitted inhaled doses are set below doses associated with these effects. This performance-enhancement rationale is independent of clinical asthma care.",
    ),
    (
...
comments_r2 = [
    ...
    (
        ...
        "The Introduction now states that WADA's objective is to permit appropriate medical care provided the use would produce no additional enhancement beyond a return to normal health and does not confer an unfair advantage.",
    ),
    (
    ...
    (
        ...
        "The ADHD section now explicitly explains WADA's rationale: stimulants may acutely improve alertness and concentration in competition, whereas out-of-competition treatment continuity is permitted because detection windows are shorter and clinical need persists.",
    ),
    (
    ...
    (
        ...
        "The hypogonadism section now explicitly states WADA's concern that testosterone restoration can be abused to produce supraphysiological effects, and explains why the organic-only rule seeks to prevent misuse.",
    ),
    (
...
comments_ae = [
    ...
    ("INTRODUCTION – You need page numbers.", "Page numbers have been added to the footer."),
    (
