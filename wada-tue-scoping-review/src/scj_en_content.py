...
INTRO = [
    ...
    (
        ...
        'and International Federations varies considerably. In some jurisdictions, TUE applications are '
        'effectively restricted to athletes who have already achieved elite-level results or who have '
        'a prior anti-doping rule violation, excluding emerging, sub-elite, and recreational competitors '
        'from the process. This creates a structural inequity in which the right to receive evidence-based '
        'medical treatment while competing depends not on medical need but on competitive achievement or '
        'prior regulatory interaction. The author\'s direct experience as a competitive bodybuilder under '
        'Japan Anti-Doping Agency (JADA) jurisdiction, where anti-doping education sessions explicitly '
        'stated that TUE submissions were limited to athletes with prior top placements or rule violations, '
        'illustrates this operational reality that may not be apparent from the regulatory framework alone.'
    ),
]
...
DISEASE_RESULTS = {
    ...
    'Attention-Deficit/Hyperactivity Disorder (ADHD)': [
        ...
        (
            ...
            'rules, practical implementation varies by NADO and sport. The author\'s experience in JADA-regulated '
            'competitive bodybuilding revealed that anti-doping education sessions explicitly stated TUE '
            'applications could only be submitted by athletes with prior top placements at national competitions '
            'or prior anti-doping rule violations. Whether this reflects JADA-specific policy, testing capacity '
            'constraints, or sport-specific implementation, the practical effect is that emerging athletes '
            'diagnosed with ADHD\u2014who may most need the structured support that sport and training provide\u2014are '
            'denied access to the TUE pathway that would allow them to compete while receiving guideline-directed '
...
DISCUSSION = [
    ...
    (
        ...
        'this review, the author\'s experience in JADA-regulated competitive bodybuilding demonstrated that TUE '
        'access was operationally restricted to athletes with prior elite-level placements or anti-doping '
        'violations\u2014effectively creating a two-tier system where medical treatment rights during competition '
        'depend on competitive achievement rather than clinical need. This jurisdictional variability means '
        'that the clinical-competition gap is not merely a policy-level discrepancy but manifests as unequal '
        'access to care for athletes in different countries, sports, and competitive tiers. The implications '
        'are particularly concerning for athletes in less-resourced NADOs, emerging sports, and sub-elite '
        'competitive categories, where TUE infrastructure may be underdeveloped. Addressing the clinical-competition '
        'gap therefore requires not only harmonization of TUE criteria with clinical evidence but also '
        'standardization of TUE access mechanisms across jurisdictions (21, 23).'
    ),
    (
